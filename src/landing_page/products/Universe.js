       ...
       <div className='container mt-5 p-5'>
        <div className='row text-center p-5'>
            ...
            <div className='col-4 p-3 mt-5'>
                <img src='media/images/zerodhaFundhouse.png' style={{width : "55%"}} alt='an image'/>
            ...
            <div className='col-4 p-3 mt-5'>
            <img src='media/images/sensibullLogo.svg' style={{width : "55%"}} alt='an image'/>
            ...
            <div className='col-4 p-3 mt-5'>
            <img src='media/images/tijori.svg' style={{width : "50%"}} alt='an image'/>
            ...
            <div className='col-4 p-3 mt-5'>
                <img src='media/images/streakLogo.png' style={{width : "50%"}} alt='an image'/>
            ...
            <div className='col-4 p-3 mt-5'>
            <img src='media/images/smallcaseLogo.png' alt='an image'/>
            ...
            <div className='col-4 p-3 mt-5'>
            <img src='media/images/dittoLogo.png' style={{width : "50%"}} alt='an image'/>
