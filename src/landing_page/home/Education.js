    ...
    return (
        <div className='container mt-5'>
            <div className='row p-5'>
                <div className='col'>
                    <img style={{width : "80%"}} src='media/images/education.svg' alt='education image'/>
                </div>
                <div className='col'>
                    ...
                    <a style={{textDecoration : "none"}} href=''>Versity <i className="fa-solid fa-arrow-right-long"></i></a>
                    ...
                    <a style={{textDecoration : "none"}} href=''>TradingQ&A <i className="fa-solid fa-arrow-right-long"></i></a>
                </div>
            </div>
        </div> 
    );
