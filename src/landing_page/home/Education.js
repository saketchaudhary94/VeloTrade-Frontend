        ...
        <div className='container mt-5'>
            <div className='row p-5'>
                ...
                <div className='col'>
                    ...
                    <a style={{textDecoration : "none"}} href="/product">Versity <i className="fa-solid fa-arrow-right-long"></i></a>
                    ...
                    <a style={{textDecoration : "none"}} href="/product">TradingQ&A <i className="fa-solid fa-arrow-right-long"></i></a>
                </div>
            </div>
        </div> 
    );
